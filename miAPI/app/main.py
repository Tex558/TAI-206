...
class UsuarioPrestamo(BaseModel):
    nombre: str = Field(..., min_length=2, max_length=100, description="Nombre del usuario", example="Emiliano Jimenez")
    correo: str = Field(..., min_length=5, max_length=120, description="Correo del usuario", example="emjican@gmail.com")
...
class LibroBase(BaseModel):
    ...
    anio: int = Field(..., gt=1450, le=datetime.now().year, description="Año del libro (>1450 y <= año actual)", example=1967)
    paginas: int = Field(..., gt=1, description="Número de páginas", example=417)
